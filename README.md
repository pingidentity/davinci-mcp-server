...
A [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server that provides AI assistants with seamless access to PingIdentity DaVinci identity orchestration platform resources. This server enables AI models to interact with DaVinci flows, applications, connectors, variables, and forms through a standardized interface.
...
- **User Permissions**: DaVinci Admin Read Only role (minimum required)
...
- **DaVinci Admin Read Only** (minimum required)
- Or **DaVinci Admin** for full access
